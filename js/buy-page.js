...
function createModal(struct){
    ...
    div.innerHTML = 
                ...
                <section class="pay-modal-info">
                    <div class="pay-modal-bder">
                        <div class="pay-modal-info-wrap">
                            <div class="first-info mg-bt pd">
                                <div class="fi__img">
                                    <img src="./img/Phone/icon-color/phone3/phone-slide-0.jpg" alt="">
                                </div>
                                <div class="fi__content">
                                    <h1 class="name">${struct.Phone}</h1>
                                    <h3>${struct.Ram}, ${struct.Camera}, ${struct.Connect}</h3>
                                    <p>${struct.Time.d}/${struct.Time.m}/${struct.Time.y} | ${struct.Time.t.h} giờ - ${struct.Time.t.m} phút</p>
                                    <span class="status">trạng thái: <b class="animate__animated">Sẵn sàng</b></span>
                                </div>
                            </div>
                        </div>
                        <div class="pay-modal-info-wrap bg1">
                            <div class="title-info pd">
                                <h3>Sản phẩm</h3>
                                <h3>Giá</h3>
                            </div>
                        </div>
                        <div class="pay-modal-info-wrap">
                            <div class="title-info pd">
                                <h3 class="name">${struct.Phone}</h3>
                                <h3 class="price">${struct.Price}</h3>
                            </div>
                        </div>
                        <div class="pay-modal-info-wrap">
                            <div class="title-info pd">
                        ...
                        <div class="pay-modal-info-wrap pd">
                            <div class="pm-cta">
